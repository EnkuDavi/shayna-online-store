                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="product-thumbs">
                                    <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false" :autoplay="true">
                                        <div class="pt" :class="thumbs[0] == gambarDefault ? 'active' : ''" @click="changeImage(thumbs[0])">
                                            <img src="img/mickey1.jpg" alt="" />
                                        </div>
                                         <div class="pt" :class="thumbs[1] == gambarDefault ? 'active' :''" @click="changeImage(thumbs[1])">
                                            <img src="img/mickey2.jpg" alt="" />
                                        </div>

                                        <div class="pt" :class="thumbs[2] == gambarDefault ? 'active' : ''" @click="changeImage(thumbs[2])">
                                            <img src="img/mickey3.jpg" alt="" />
                                        </div>

                                        <div class="pt" :class="thumbs[3] == gambarDefault ? 'active' : ''" @click="changeImage(thumbs[3])">
